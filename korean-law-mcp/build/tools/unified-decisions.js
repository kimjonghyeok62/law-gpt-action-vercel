...
export const SearchDecisionsSchema = z.object({
    domain: z.enum(DOMAINS).describe(`검색 대상 도메인: ${domainDescriptions}`),
    ...
    options: z.record(z.string(), z.unknown()).optional().describe("도메인별 추가 옵션. " +
...
export const GetDecisionTextSchema = z.object({
    domain: z.enum(DOMAINS).describe(`조회 대상 도메인: ${domainDescriptions}`),
